...
class Player(tk.Frame):
	...
	def create_frames(self):
		self.track = tk.LabelFrame(self, text='Song',
	...
	def track_widgets(self):
		...
		self.songtrack = tk.Label(self.track, font=("google sans",16,"bold"),
						bg="blue",fg="black")
		self.songtrack['text'] = 'Listen! the music app'
...
root.wm_title('listen! the music player')
